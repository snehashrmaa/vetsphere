...
import { getToolBySlug, SUBJECT_COLORS } from '@/data/clinicTools';
...
function ToolNotFound() {
  return (
    ...
    >
      ...
      <h2 className="text-2xl font-bold font-heading mb-2">Tool Not Found</h2>
      <p className="text-muted-foreground mb-6 max-w-sm">
        The tool you're looking for doesn't exist. Check the URL or browse all tools below.
      </p>
      <Link to="/clinic">
        <Button variant="primary">Browse Clinic</Button>
      </Link>
    </motion.div>
  );
}
...
// ─── Page ─────────────────────────────────────────────────────────────────────
export default function ClinicToolPage() {
