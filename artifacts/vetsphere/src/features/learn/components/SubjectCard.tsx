...
// SVG progress ring — always 0% (track only)
  ...
  return (
    <div className="relative w-9 h-9 flex items-center justify-center shrink-0">
      <svg width={radius * 2} height={radius * 2} className="-rotate-90">
        ...
        />
        {/* Fill at 0% — invisible arc, keeps the ring shape */}
        <circle
          cx={radius} cy={radius} r={nr}
          fill="transparent"
          stroke="currentColor"
  ...
  return (
    ...
    >
      ...
      <div className="p-4 flex flex-col gap-3">
        ...
        {/* Progress ring + Coming Soon badge */}
        <div className="flex items-center justify-between">
          <ProgressRing />
          <span className={cn(
            'px-2 py-0.5 rounded-full text-[10px] font-semibold tracking-wide border border-white/5',
